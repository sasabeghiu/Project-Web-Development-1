...
<div class="album py-5">
    <div class="container mb-5">
        <h2 class="text-light text-center">Residents</h2>
            ...
            ?>
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="<?= $resident->getPhoto() ?>" class="product-card img">
                        <div class="card-body text-light bg-dark">
                            <p class="card-text fw-bold"><?= $resident->getName() ?></p>
                            <p class="card-text"><?= $resident->getDescription() ?></p>
