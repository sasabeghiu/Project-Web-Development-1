...
<body>
  <nav class="navbar navbar-expand-md navbar-black bg-black mb-4">
    <div class="container">
      <a class="navbar-brand" href="/"><img src="../img/test.png" alt="" class="logoheader"></a>
      <button class="navbar-dark navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link text-light" href="/resident">Residents</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="/event">Events</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="/merchandise">Merchandise</a>
          </li>
          <li class="nav-item">
